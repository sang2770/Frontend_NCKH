  ...
  return (
    <form className={style.Form_main} onSubmit={SubmitForm}>
      ...
      <div className={style.Form_Container}>
        ...
        <div className={style.FormItem}>
          <ElementForm data={data} title={titles[3]} subtitle={subtitles[3]} Ref={FilterNgayDK}/>
        </div>
        <div className={style.FormItem}>
          <ElementForm data={data} title={titles[4]} subtitle={subtitles[4]} Ref={FilterSoDK}/>
        </div>
        <div className={style.FormItem}>
          <ElementForm data={data} title={titles[5]} subtitle={subtitles[5]} Ref={FilterNoiDK}/>
        </div>
        <div className={style.FormItem}>
          <ElementForm data={data} title={titles[6]} subtitle={subtitles[6]} Ref={FilterDiaChi}/>
        </div>
        <div className={style.FormItem}>
          <ElementForm data={data} title={titles[7]} subtitle={subtitles[7]} Ref={FilterNgayNop}/>
        </div>
      </div>
      <hr />
      <h1 className={style.form_title}>
      ...
      <div className={style.Form_ContainerMove}>
        <div className={style.FormItemMove}>
          <ElementForm data={data} title={titles[8]} subtitle={subtitles[8]} Ref={FilterSoGT}/>
        </div>
        <div className={style.FormItemMove}>
          <ElementForm data={data} title={titles[9]} subtitle={subtitles[9]} Ref={FilterBanChiHuy}/>
        </div>
        <div className={style.FormItemMove}>
